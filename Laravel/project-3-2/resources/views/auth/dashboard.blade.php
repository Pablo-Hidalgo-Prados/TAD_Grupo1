                    ...
                    <div class="card-body">
                        <form action="{{ route('productos.crear') }}" method="post">
                            ...
                            <input id="stock" type="text"
                                class="form-control @error('stock') is-invalid @enderror mt-1" name="stock" value=""
                        ...
                        <div class="card-body">
                            <form action="{{ route('categorias.crear') }}" method="post">
                                ...
                                <input id="descripcionc" type="text"
                                    class="form-control @error('descripcionc') is-invalid @enderror mt-1"
                                    name="descripcionc" value="" placeholder="Descripcion" required autofocus>
